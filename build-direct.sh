...
cp app/build/outputs/apk/debug/app-debug.apk build/direct/VGrop-market-v0.15.0-debug.apk
"$ANDROID_HOME/build-tools/35.0.1/apksigner" verify --verbose --print-certs build/direct/VGrop-market-v0.15.0-debug.apk
