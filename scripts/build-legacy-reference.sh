...
"$bt/apksigner" sign --ks debug.keystore --ks-pass pass:android --key-pass pass:android --out "$out/VGrop-market-v0.15.0-debug.apk" "$out/aligned.apk"
"$bt/apksigner" verify --verbose "$out/VGrop-market-v0.15.0-debug.apk"
